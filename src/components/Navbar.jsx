...
import { BookOpen, Bell, Search, Menu, X, Upload, LayoutDashboard, User, LogIn, LogOut } from 'lucide-react'
...
export default function Navbar() {
    ...
    return (
        <nav className="sticky top-0 z-50 glass border-b" style={{ borderColor: 'var(--edu-border)' }}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    {/* Logo */}
                    <Link to="/" className="flex items-center gap-2.5 group">
                        <div className="w-9 h-9 rounded-xl flex items-center justify-center glow-sm transition-all group-hover:scale-110"
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        <button className="w-9 h-9 rounded-lg flex items-center justify-center transition-all hover:bg-white/5"
            ...
            {/* Mobile Menu */}
            {menuOpen && (
                <div className="md:hidden border-t px-4 py-4 space-y-1" style={{ borderColor: 'var(--edu-border)', background: 'var(--edu-surface)' }}>
                    {navLinks.map(link => (
                        <Link key={link.to} to={link.to}
                    ...
                    <div className="pt-2 border-t flex gap-2" style={{ borderColor: 'var(--edu-border)' }}>
                        {currentUser ? (
